    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aParent', models.ForeignKey(blank=True, to='goodslist.AreaInfo', null=True)),
            ],
            options={
                'db_table': 'areainfo',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra', models.CharField(max_length=20, null=True, blank=True)),
                ('goods', models.ForeignKey(to='goodslist.Goods')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('good_id', models.ForeignKey(to='goodslist.Goods')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(to='goodslist.UserInfo'),
        ),
        migrations.AddField(
            model_name='orders',
            name='userOrder',
        ...
        migrations.AddField(
            ...
            name='orders_id',
            field=models.ForeignKey(to='goodslist.Orders'),
        ),
        migrations.AddField(
            model_name='goods',
            name='goodSort',
            field=models.ForeignKey(to='goodslist.GoodSort'),
        ),
        migrations.AddField(
            model_name='cart',
            name='userCart',
