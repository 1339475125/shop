    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aParent', models.ForeignKey(blank=True, to='usercenter.AreaInfo', null=True)),
            ],
            options={
                'db_table': 'areainfo',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra', models.CharField(max_length=20, null=True, blank=True)),
                ('goods', models.ForeignKey(to='usercenter.Goods')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='goods',
            name='goodSort',
            field=models.ForeignKey(to='usercenter.GoodSort'),
        ),
        migrations.AddField(
            model_name='cart',
            name='userCart',
